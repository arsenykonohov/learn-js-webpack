...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?minimize!./../../../../node_modules/postcss-loader/index.js!./style.nav.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?minimize!./../../../../node_modules/postcss-loader/index.js!./style.nav.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".nav{display:block;min-height:50px;background-color:#304e79;z-index:4}.nav__list{display:block;text-align:center}.nav__item{color:#fff;display:inline-block;margin:0}.nav__item a{font-size:14px;text-transform:uppercase;display:block;line-height:30px;padding:10px 20px}.nav__item a:hover{background-color:rgba(0,0,0,.3);-webkit-transition:all .5s;transition:all .5s;-webkit-box-shadow:inset 0 2px 6px rgba(0,0,0,.4);box-shadow:inset 0 2px 6px rgba(0,0,0,.4)}", ""]);
